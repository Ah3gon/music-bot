...
PREVIEW_MAX_MS        = 35000  # короче — считаем превью SoundCloud, не полный трек
BOT_NAME              = "Surge"
HISTORY_LIMIT         = 20
